...
en.WelcomeLabel2=This will install [name/ver] on your computer which includes Ruby 1.8.7, Git, Sqlite3, DevKit, Rails 3 and TinyTDS with FreeTDS.  Please close any console applications before continuing.
