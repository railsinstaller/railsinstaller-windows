...
Source: {#StagePath}\DevKit\config.yml; DestDir: {app}\DevKit; Flags: recursesubdirs createallsubdirs; AfterInstall: UpdateDevKitConfig('{app}\{#RubyPath}', '{app}\DevKit\config.yml')
